...
\end{table}
	...
	\subsubsection{Different Galois Schedules vs OpenMP}
    	Figure X compares the Scalability for different Galois Schedules and OpenMP for the sparse dataset Mnist.
	The chunked implementations scales better compared to un-chunked version for both Galois and OpenMP. This is expected as the chunked
    	...
    	the Chunked and DChunked-FIFO Scheduling have better scalability than the FIFO scheduling. Also, OpemMP
