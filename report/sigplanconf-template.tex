...
First, what is the most effective method of minimizing the objective function. Second, how does one choose the tuning parameter λ. 
...
//Add the 2 different implementations
...
\end{table}
	...
	Also, Chunked FIFO Galois scheduling give much better speeup compared to FIFO scheduling for the worklist.
